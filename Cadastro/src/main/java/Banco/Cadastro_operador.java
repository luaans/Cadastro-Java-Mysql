 ...
 * @author Aluno
 */
public class Cadastro_operador extends javax.swing.JFrame {

    /**
     * Creates new form cadastro_operador
     */
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGap(83, 83, 83)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(funcao, javax.swing.GroupLayout.PREFERRED_SIZE, 159, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String sql = "INSERT INTO Operador (matricula, nome, idade, funcao) VALUES (?, ?, ?, ?)";
         try {
            ...
            PreST.setString(2, op.getNome());
            PreST.setInt(3, op.getIdade());
            PreST.setString(4, op.getFuncao());
            PreST.executeUpdate();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Cadastro_operador.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Cadastro_operador().setVisible(true);
            }
        });
    }
